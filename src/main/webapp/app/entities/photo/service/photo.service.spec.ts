...
import { PhotoService, RestPhoto } from './photo.service';

const requireRestSample: RestPhoto = {
  ...sampleWithRequiredData,
  taken: sampleWithRequiredData.taken?.toJSON(),
  uploaded: sampleWithRequiredData.uploaded?.toJSON(),
};
